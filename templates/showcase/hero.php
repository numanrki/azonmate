<?php
/**
 * Template: Showcase – Hero Card (Single Product)
 *
 * Large featured product display with image panel, highlights, and prominent CTA.
 *
 * @package AzonMate
 * @since   1.3.0
 *
...
?>
<div class="azonmate-showcase azonmate-showcase--hero<?php echo esc_attr( $size_class ); ?>">
	<?php if ( ! empty( $heading ) ) : ?>
		<h2 class="azonmate-showcase__heading"><?php echo esc_html( $heading ); ?></h2>
	<?php endif; ?>

	<div class="azonmate-showcase__hero" data-asin="<?php echo esc_attr( $asin ); ?>">

		<div class="azonmate-showcase__hero-image">
		...
		<div class="azonmate-showcase__hero-body">
			<?php if ( $brand ) : ?>
			...
			<?php if ( $description ) : ?>
				<p class="azonmate-showcase__desc"><?php echo esc_html( wp_trim_words( $description, 35 ) ); ?></p>
			<?php endif; ?>
			...
			<?php if ( $show_price && $price ) : ?>
				<div class="azonmate-showcase__price-wrap">
					<span class="azonmate-showcase__price azonmate-showcase__price--hero"><?php echo esc_html( $price ); ?></span>
